...
public class StaticVsInstanceAnswer {
    public static void main(String[] args) {
        ...
        StaticVsInstanceAnswer testInstance = new StaticVsInstanceAnswer();

        testInstance.setMember(member1,"자바자바",31,21);
        testInstance.setMember(member2,"어려버라",22,10);
